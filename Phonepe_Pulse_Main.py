...
icon = Image.open("C:/Users/saura/Downloads/phonepe.png")
st.set_page_config(page_title= "Phonepe Pulse Data Visualization | By SAURABH TIWARI",
                   page_icon= icon,
                   layout= "wide",
                   initial_sidebar_state= "expanded",
                   menu_items={'About': """# This dashboard app is created by *Saurabh Tiwari*!
...
# EXPLORE DATA - TRANSACTIONS
    if Type == "Transactions":
        ...
        with col1:
            ...
            df2 = pd.read_csv('C:/Users/saura/Downloads/Phonepe_Pulse_Data_Visualization-main/Phonepe_Pulse_Data_Visualization-main/Data/Statenames.csv')
            df1.State = df2
...
if selected == "About":
    ...
    with col1:
        ...
        st.write("https://github.com/saurabh-tiwari1995/phone-pay")
